...
public class Timeline extends Weibo{
	 ...
	 *             when Weibo service or network is unavailable
	 * @version weibo4j-V2 1.0.0
	 * @see <a href="http://open.weibo.com/wiki/2/direct_messages/new.json">direct_messages/new</a>
	 * @since JDK 1.5
	 */	
	public DirectMessage  sendDirectMessage(String uid, String text) throws WeiboException {
